...
switch name1
 ...
 %%% Nightowls section
  case 'nightowls'
    setIds=1:3; subdir='nightowls'; skip=1; ext='png'; vidIds={1:26 1:5 1:8};
  case 'nightowlstrain'
    setIds=1; subdir='nightowls'; skip=1; ext='png';  vidIds={1:26};
  case 'nightowlsval'
    setIds=2; subdir='nightowls'; skip=1; ext='png';  vidIds={1:5};
  case 'nightowlstest'
    setIds=3; subdir='nightowls'; skip=1; ext='png';  vidIds={1:8};
